...
const SuccessPage = () => {
    ...
    const isYearly = planType === "year";

    const benefits = isYearly
        ? [
            "Access to all premium courses for a full year",
            "Save more compared to monthly subscription",
            "Priority support",
    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-16 max-w-4xl h-screen flex items-center justify-center">
            <Card className="w-full overflow-hidden">

                {/* Top gradient bar */}
                <div
                    className={`w-full h-2 ${isYearly
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3">
                            {benefits.map((benefit, index) => (
                                ...
                                >
                                    <Check
                                        className={`flex-shrink-0 h-6 w-6 ${isYearly
                                                ? "text-purple-500"
                                                : "text-green-500"
                                            }`}
                                    />
